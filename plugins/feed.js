let handler = async (m, { conn, args, usedPrefix, command }) => {
    ...
    switch (type) {
        case 'rubah':
            ...
            if (rubah == 5) return m.reply('*⚠️Pet kamu dah lvl max*')
            ...
            if (new Date - global.db.data.users[m.sender].rubahlastclaim > 600000) {
                if (global.db.data.users[m.sender].makananpet > 0) {
                    ...
                    setTimeout(() => {
                         conn.reply(m.chat, '⚠️Waktunya memberi makan pet *Rubah*', m)
                    }, timebah)
                    if (rubah > 0) {
            ...
            } else m.reply(`⚠️Pet kamu sudah kenyang, coba kasih makan *${waktur}* lagi`)
            break
        case 'kuda':
            ...
            if (new Date - global.db.data.users[m.sender].kudalastclaim > 600000) {
                if (global.db.data.users[m.sender].makananpet > 0) {
                    ...
                    conn.reply(m.chat, `Berhasil memberi makan pet ${type}`, m)
                    setTimeout(() => {
                         conn.reply(m.chat, '⚠️Waktunya memberi makan pet *Kuda*', m)
                    }, timeda)
                    if (kuda > 0) {
            ...
            } else m.reply(`⚠️Pet kamu sudah kenyang, coba kasih makan *${waktuk}* lagi`)
            break
        case 'serigala':
            if (serigala == 0) return m.reply('*❌Kamu belum memiliki Pet Serigala*')
            if (serigala == 15) return m.reply('*⚠️Pet kamu dah lvl max*')
            ...
            if (new Date - global.db.data.users[m.sender].serigalalastclaim > 600000) {
                if (global.db.data.users[m.sender].makananpet > 0) {
                    ...
                    conn.reply(m.chat, `Berhasil memberi makan pet ${type}`, m)
                    setTimeout(() => {
                         conn.reply(m.chat, '⚠️Waktunya memberi makan pet *Serigala*', m)
                    }, timela)
                    if (serigala > 0) {
            ...
            } else m.reply(`⚠️Pet kamu sudah kenyang, coba kasih makan *${waktus}* lagi`)
            break
        case 'naga':
            if (naga == 0) return m.reply('*❌Kamu belum memiliki Pet naga*')
            if (naga == 20) return m.reply('*⚠️Pet kamu dah lvl max*')
            ...
            if (new Date - global.db.data.users[m.sender].nagalastclaim > 600000) {
                if (global.db.data.users[m.sender].makanannaga > 0) {
                    ...
                    conn.reply(m.chat, `Berhasil memberi makan pet ${type}`, m)
                    setTimeout(() => {
                         conn.reply(m.chat, '⚠️Waktunya memberi makan pet *Naga*', m)
                    }, timega)
                    if (naga > 0) {
            ...
            } else m.reply(`⚠️Pet kamu sudah kenyang, coba kasih makan *${waktug}* lagi`)
            break 
      case 'kyubi':
            if (kyubi == 0) return m.reply('*❌Kamu belum memiliki Pet kyubi*')
            if (kyubi == 20) return m.reply('*⚠️Pet kamu dah lvl max*')
            ...
            if (new Date - global.db.data.users[m.sender].kyubilastclaim > 600000) {
                if (global.db.data.users[m.sender].makanankyubi > 0) {
                    ...
                    conn.reply(m.chat, `✅Berhasil memberi makan pet ${type}`, m)
                    setTimeout(() => {
                         conn.reply(m.chat, '⚠️Waktunya memberi makan pet *Kyubi*', m)
                    }, timebi)
                    if (kyubi > 0) {
            ...
            } else m.reply(`⚠️Pet kamu sudah kenyang, coba kasih makan *${waktuyu}* lagi`)
            break 
      case 'centaur':
            if (centaur == 0) return m.reply('*❌Kamu belum memiliki Pet centaur*')
            if (centaur == 20) return m.reply('*⚠️Pet kamu dah lvl max*')
            ...
            if (new Date - global.db.data.users[m.sender].centaurlastclaim > 600000) {
                if (global.db.data.users[m.sender].makanancentaur > 0) {
                    ...
                    conn.reply(m.chat, `✅Berhasil memberi makan pet ${type}`, m)
                    setTimeout(() => {
                         conn.reply(m.chat, '⚠️Waktunya memberi makan pet *Centaur*', m)
                    }, timeur)
                    if (centaur > 0) {
            ...
            } else m.reply(`⚠️Pet kamu sudah kenyang, coba kasih makan *${waktuur}* lagi`)
            break 
         case 'phonix':
            if (phonix == 0) return m.reply('*❌Kamu belum memiliki Pet Phonix*')
            if (phonix == 15) return m.reply('*⚠️Pet kamu dah lvl max*')
            ...
            if (new Date - global.db.data.users[m.sender].phonixlastclaim > 600000) {
                if (global.db.data.users[m.sender].makananphonix > 0) {
                    ...
                    conn.reply(m.chat, `Berhasil memberi makan pet ${type}`, m)
                    setTimeout(() => {
                         conn.reply(m.chat, '⚠️Waktunya memberi makan pet *Phonix*', m)
                    }, timenix)
                    if (phonix > 0) {
            ...
            } else m.reply(`⚠️Pet kamu sudah kenyang, coba kasih makan *${waktux}* lagi`)
            break
        case 'griffin':
            if (griffin == 0) return m.reply('*❌Kamu belum memiliki Pet Griffin*')
            if (griffin == 15) return m.reply('*⚠️Pet kamu dah lvl max*')
            ...
            if (new Date - global.db.data.users[m.sender].griffinlastclaim > 600000) {
                if (global.db.data.users[m.sender].makanangriffin > 0) {
                    ...
                    conn.reply(m.chat, `Berhasil memberi makan pet ${type}`, m)
                    setTimeout(() => {
                         conn.reply(m.chat, '⚠️Waktunya memberi makan pet *Griffin*', m)
                    }, timefin)
                    if (griffin > 0) {
            ...
            } else m.reply(`⚠️Pet kamu sudah kenyang, coba kasih makan *${waktufin}* lagi`)
            break
        case 'kucing':
            ...
            if (new Date - global.db.data.users[m.sender].kucinglastclaim > 600000) {
                if (global.db.data.users[m.sender].makananpet > 0) {
                    ...
                    conn.reply(m.chat, `✅Berhasil memberi makan pet ${type}`, m)
                    setTimeout(() => {
                         conn.reply(m.chat, '⚠️Waktunya memberi makan pet *Kucing*', m)
                    }, timecing)
                    if (kucing > 0) { 
            ...
            } else m.reply(`⚠️Pet kamu sudah kenyang, coba kasih makan *${waktu}* lagi`)
            break
        case 'hero':
            if (hero == 0) return m.reply('*❌Kamu belum memiliki Hero*')
            if (hero == 100) return m.reply('*⚠️hero kamu dah lvl max*')
            ...
            if (new Date - global.db.data.users[m.sender].herolastclaim > 600000) {
                if (global.db.data.users[m.sender].pillhero > 0) {
                    ...
                    setTimeout(() => {
                         conn.reply(m.chat, '⚠️Waktunya memberi makan *Hero*', m)
                    }, timeher)
                    if (hero > 0) { 
            ...
            } else m.reply(`⚠️Herokamu sudah kenyang, coba kasih makan *${waktuher}* lagi`)
            break
        default:
            return conn.reply(m.chat, `⚠️ ${usedPrefix + command} [hero | kucing | rubah | kuda | naga | centaur | kyubi | griffin | phonix | serigala]\n⚠️Contoh penggunaan: *${usedPrefix + command} kucing*`, m)
    }
}
